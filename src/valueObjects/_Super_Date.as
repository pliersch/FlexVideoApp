 ...
 * of this value object you may modify the generated sub-class of this class - Date.as.
 */
...
[ExcludeClass]
public class _Super_Date extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    model_internal static function initRemoteClassAliasSingle(cz:Class) : void
    {
        try
        {
            if (flash.net.getClassByAlias("java.sql.Date") == null)
            {
                flash.net.registerClassAlias("java.sql.Date", cz);
            }
        }
        catch (e:Error)
        {
    ...
    model_internal var _dminternal_model : _DateEntityMetadata;
    ...
    public function _Super_Date()
    {
        _model = new _DateEntityMetadata(this);
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _DateEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _DateEntityMetadata) : void
    {
        var oldValue : _DateEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
